...
Hits the network. Install: ``pip install isotrieve[openai]``.
Always wrap with :func:`isotrieve.providers.cached.with_disk_cache` in production.
"""
    ...
    def __init__(
        ...
        *,
        ...
        try:
            ...
            raise ImportError(
                "openai is required. Install with: pip install isotrieve[openai]"
            ) from e
