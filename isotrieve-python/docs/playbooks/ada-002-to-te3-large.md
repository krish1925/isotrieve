...
Re-embedding a 1M-vector corpus costs ~$0.26 in API calls. Isotrieve handles the dimension
...
Isotrieve's `RidgeMapping` handles non-square transforms (1536 → 3072) natively.
...
isotrieve calibrate --source-model text-embedding-ada-002 \
               ...
               --k 2000 \
               -o ada002_to_te3l.isotrieve

# 3. Gate — verify retention
isotrieve gate --mapping ada002_to_te3l.isotrieve \
          --source-vectors X_sample.npy \
          --target-vectors Y_sample.npy

# 4. If PASS, migrate
isotrieve transform --mapping ada002_to_te3l.isotrieve \
