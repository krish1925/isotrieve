...
AECP fits a mapping from 2K calibration texts for a fraction of that — without touching stored vectors.
...
aecp calibrate --source-model text-embedding-ada-002 \
               ...
               --k 2000 \
               -o ada002_to_te3s.aecp

# 3. Gate — verify retention
aecp gate --mapping ada002_to_te3s.aecp \
          --source-vectors X_sample.npy \
          --target-vectors Y_sample.npy

# 4. If PASS, migrate
aecp transform --mapping ada002_to_te3s.aecp \
